...
public class TestingIDCRT {
    ...
    public void ContinueToPaymentCRT005() throws InterruptedException {
        ...
        // Wait for the "CONTINUAR" button to appear.
        By continueButtonSelectorCM = By.xpath("//*[@id=\"cart-buy-btn\"]");
        WebElement continueButtonCM = chromeWait.until(ExpectedConditions.elementToBeClickable(continueButtonSelectorCM));

        // The "CONTINUAR" button is clicked.
        continueButtonCM.click();

        // Wait fot the login window to appear.
        By loginWindowSelectorCM = By.xpath("//*[@id=\"loginBody\"]/div");
        WebElement loginWindowCM = chromeWait.until(ExpectedConditions.elementToBeClickable(loginWindowSelectorCM));
        ...
        if (loginWindowCM.isDisplayed()) {
            ...
            Assert.fail("The login window is not visible in Chrome.");
        }
        ...
        // Wait for the "CONTINUAR" button to appear.
        By continueButtonSelectorME = By.xpath("//*[@id=\"cart-buy-btn\"]");
        WebElement continueButtonME = edWait.until(ExpectedConditions.elementToBeClickable(continueButtonSelectorME));

        // The "CONTINUAR" button is clicked.
        continueButtonME.click();

        // Wait fot the login window to appear.
        By loginWindowSelectorME = By.xpath("//*[@id=\"loginBody\"]/div");
        WebElement loginWindowME = edWait.until(ExpectedConditions.elementToBeClickable(loginWindowSelectorME));

        // It is verified that login window is visible.
        if (loginWindowME.isDisplayed()) {
            System.out.println("The login window is visible in in Microsoft Edge.");
        } else {
            Assert.fail("The login window is not visible in in Microsoft Edge.");
        }
    }
